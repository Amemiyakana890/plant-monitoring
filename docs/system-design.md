...
| # | 部品 | 説明 |
|---|---|---|
| 1 | ATOM Matrix | Wi-Fi/Bluetooth対応マイコンモジュール。センサーデータを収集しアプリへ送信 |
| 2 | ATOM PortABC拡張ベース | 拡張機 |
| 2 | ENV Ⅲ | 温度・湿度・気圧センサー(I2C接続) |
| 3 | 土壌水分センサー | (GPIO接続) |
| 4 | 光センサーユニット(予定) | (GPIO接続) |
